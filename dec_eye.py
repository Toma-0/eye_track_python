...
def img_keep(right_eye,left_eye,frame):
    ...
    cv2.imshow('face', right_eye_frame)
    dec_black.dec_eye(right_eye_frame)
    #left_eye_frame=frame[left_eye[2]:left_eye[1], left_eye[3]:left_eye[0]]
    #dec_black.dec_eye(left_eye_frame)